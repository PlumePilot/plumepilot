(() => {
  ...
  const findFirstIncompleteButton = document.getElementById(
    "findFirstIncomplete",
  );
  const firstIncompleteStatus = document.getElementById(
    "firstIncompleteStatus",
  );
  const testBehaviorRadios = [
    ...document.querySelectorAll('input[name="testBehavior"]'),
  ];
  const chapterLimitEnabledCheckbox = document.getElementById(
    "chapterLimitEnabled",
  );
  ...
  const chapterLimitOptionsSummary = document.getElementById(
    "chapterLimitOptionsSummary",
  );
  ...
  const courseProgressMessage = document.getElementById(
    "courseProgressMessage",
  );
  const courseProgressThresholdMarker = document.getElementById(
    "courseProgressThresholdMarker",
  );
  const courseProgressOverlayEnabledCheckbox = document.getElementById(
    "courseProgressOverlayEnabled",
  );
  const courseProgressPositionFieldset = document.getElementById(
    "courseProgressPositionFieldset",
  );
  const courseProgressPositionRadios = [
    ...document.querySelectorAll('input[name="courseProgressOverlayPosition"]'),
  ];
  const courseProgressThresholdEnabledCheckbox = document.getElementById(
    "courseProgressThresholdEnabled",
  );
  const autoplayStopAt70EnabledCheckbox = document.getElementById(
    "autoplayStopAt70Enabled",
  );
  const autoplayStopAt70Resume = document.getElementById(
    "autoplayStopAt70Resume",
  );
  const courseProgressOptionsSummary = document.getElementById(
    "courseProgressOptionsSummary",
  );
  ...
  const visualStyleRadios = [
    ...document.querySelectorAll('input[name="visualStyle"]'),
  ];
  const themePreferenceRadios = [
    ...document.querySelectorAll('input[name="themePreference"]'),
  ];
  const menuSizeRadios = [
    ...document.querySelectorAll('input[name="menuSize"]'),
  ];
  const floatingMenuEnabledCheckbox = document.getElementById(
    "floatingMenuEnabled",
  );
  const floatingMenuLayoutList = document.getElementById(
    "floatingMenuLayoutList",
  );
  const resetFloatingMenuLayoutButton = document.getElementById(
    "resetFloatingMenuLayout",
  );
  const floatingMenuLayoutStatus = document.getElementById(
    "floatingMenuLayoutStatus",
  );
  const commissionCheckEnabledCheckbox = document.getElementById(
    "commissionCheckEnabled",
  );
  const autoplayControlSprite = document.getElementById(
    "autoplayControlSprite",
  );
  const floatingMenuControlSprite = document.getElementById(
    "floatingMenuControlSprite",
  );
  const commissionControlSprite = document.getElementById(
    "commissionControlSprite",
  );
  const playbackRecoveryControlSprite = document.getElementById(
    "playbackRecoveryControlSprite",
  );
  const soundNotificationsEnabledCheckbox = document.getElementById(
    "soundNotificationsEnabled",
  );
  const soundNotificationControlSprite = document.getElementById(
    "soundNotificationControlSprite",
  );
  const soundNotificationControls = document.getElementById(
  ...
  const notificationVolumeValue = document.getElementById(
    "notificationVolumeValue",
  );
  const previewNotificationSoundButton = document.getElementById(
  ...
  const commissionUpdatesTitle = document.getElementById(
    "commissionUpdatesTitle",
  );
  ...
  const markCommissionSeenButton =
    document.getElementById("markCommissionSeen");
  const clearCommissionDataButton = document.getElementById(
    "clearCommissionData",
  );
  const clearCommissionDataStatus = document.getElementById(
    "clearCommissionDataStatus",
  );
  ...
  const openWhatsNewFromAboutButton = document.getElementById(
    "openWhatsNewFromAbout",
  );
  const whatsNewDialogBackdrop = document.getElementById("whatsNewDialog");
  const closeWhatsNewDialogButton = document.getElementById(
    "closeWhatsNewDialog",
  );
  const confirmWhatsNewButton = document.getElementById("confirmWhatsNew");
  const whatsNewDialogVersion = document.getElementById(
    "whatsNewDialogVersion",
  );
  const whatsNewDialogTitle = document.getElementById("whatsNewDialogTitle");
  const whatsNewDialogSummary = document.getElementById(
    "whatsNewDialogSummary",
  );
  ...
  const turboTestsButtonLabel = document.getElementById(
    "turboTestsButtonLabel",
  );
  ...
  const objectivesButtonLabel = document.getElementById(
    "objectivesButtonLabel",
  );
  ...
  const createTestCollectionButton = document.getElementById(
    "createTestCollection",
  );
  const testCollectionButtonLabel = document.getElementById(
    "testCollectionButtonLabel",
  );
  ...
  const exportCourseMaterialsButton = document.getElementById(
    "exportCourseMaterials",
  );
  ...
  const activeOperationBanner = document.getElementById(
  ...
  const achievementProgressText = document.getElementById(
    "achievementProgressText",
  );
  const achievementProgress = document.getElementById("achievementProgress");
  const achievementProgressFill = document.getElementById(
    "achievementProgressFill",
  );
  const achievementMidMarker = achievementProgress.querySelector(
    ".achievement-mid-marker",
  );
  const achievementEndMarker = achievementProgress.querySelector(
  ...
  const secondaryAchievements = document.getElementById(
  ...
  function renderSoundPreferences(value) {
    ...
    soundNotificationsEnabledCheckbox.checked =
      normalized.soundNotificationsEnabled;
    ...
    soundNotificationControls
      ...
      .forEach((control) => {
        control.disabled = !normalized.soundNotificationsEnabled;
      });
    soundNotificationControls.closest("fieldset").dataset.disabled = String(
      !normalized.soundNotificationsEnabled,
    );
  }
  ...
  async function previewNotificationSound() {
    ...
    const response = await runtimeMessage({
      type: "STUDYWING_SOUND_PREVIEW",
      sound,
      volume,
    });
    soundPreviewStatus.textContent =
      response?.played === true
        ? volume === 0
          ? "Anteprima avviata con volume a 0%."
          : "Anteprima riprodotta."
  ...
  if (storeReviewLink && storeLinksApi) {
    storeReviewLink.href = storeLinksApi.reviewUrl(
  ...
  function openWhatsNewDialog({ markSeen = false, returnFocus = null } = {}) {
    whatsNewReturnFocus =
      returnFocus instanceof HTMLElement ? returnFocus : document.activeElement;
  ...
  function closeWhatsNewDialog() {
    ...
    if (
      whatsNewReturnFocus instanceof HTMLElement &&
      whatsNewReturnFocus.isConnected
    )
  ...
  openWhatsNewButton.addEventListener("click", () =>
    openWhatsNewDialog({ markSeen: true, returnFocus: openWhatsNewButton }),
  );
  openWhatsNewFromAboutButton.addEventListener("click", () =>
    openWhatsNewDialog({ returnFocus: openWhatsNewFromAboutButton }),
  );
  ...
  function renderAchievements(stateValue) {
    ...
    achievementProgressText.textContent = model.capped
      ? "500 / 500 EXP · Completato"
      : `${model.expWithinLevel} / 100 EXP`;
    achievementProgress.setAttribute(
      "aria-valuenow",
    ...
    for (const [group, target] of [
      ...
      const rows = achievements.CATALOGUE.filter(
        ...
        description.textContent = complete ? "Completato" : item.description;
        const exp = document.createElement("span");
        exp.className = "achievement-exp";
        exp.textContent = `+${item.exp} EXP`;
        row.append(title, description, exp);
        return row;
      });
  ...
  function applyCosmetics() {
    gamingCosmetics = achievements.normalizeCosmetics(
      gamingCosmetics,
      achievementState,
    );
    document.documentElement.dataset.barStyle = gamingCosmetics.barStyle;
    document.documentElement.dataset.launcherStyle =
      gamingCosmetics.launcherStyle;
  }
  ...
  function renderRewards() {
    ...
    const renderKind = (kind, target) => {
      target.replaceChildren(
        ...achievements.REWARD_SETS.map((set) => {
          const threshold =
          ...
          card.dataset.style = set.id;
          const preview = document.createElement("span");
          preview.className = `reward-preview reward-preview-${kind}`;
          preview.dataset.style = set.id;
          ...
          if (available) {
            ...
            button.dataset.rewardKind = kind;
            button.dataset.rewardStyle = set.id;
    ...
    renderKind("bar", barRewards);
    renderKind("launcher", launcherRewards);
    applyCosmetics();
  }

  function applyReward(kind, style) {
    if (!achievementState.unlockedCosmeticIds.includes(`${kind}:${style}`))
      return;
  ...
  async function claimAchievement(id) {
    if (document.documentElement.dataset.visualStyle !== "gaming")
    ...
    if (
      ...
      const rewards = Array.isArray(result.newUnlockIds)
        ? result.newUnlockIds.length
        : 0;
  ...
  function claimEnabledGamingAchievements() {
    ...
    if (floatingMenuEnabledCheckbox.checked)
  ...
  for (const button of tabButtons) {
    ...
    button.addEventListener("keydown", (event) => {
      ...
      const visibleTabs = tabButtons.filter(
        (candidate) =>
          !candidate.classList.contains("achievements-only") ||
          document.documentElement.dataset.visualStyle === "gaming",
      );
  ...
  function renderChapterLimit() {
    ...
    chapterLimitSlider.dataset.flameLevel = String(
      flameLevelForLimit(limit, maximum),
    );
  ...
  function renderCourseProgressPreferences(
    overlayEnabled,
    position,
    thresholdEnabled,
    stopAt70Enabled = autoplayStopAt70Enabled,
  ) {
  ...
  function selectedPlaybackErrorRecovery() {
    return (
      playbackErrorRecoveryRadios.find((radio) => radio.checked)?.value ||
      "automatic"
    );
  }
  function renderPlaybackErrorRecovery(value) {
    const normalized = value === "manual" ? "manual" : "automatic";
    for (const radio of playbackErrorRecoveryRadios)
      radio.checked = radio.value === normalized;
  }
  function selectedThemePreference() {
    return (
      themePreferenceRadios.find((radio) => radio.checked)?.value || "system"
    );
  }
  ...
  function selectedVisualStyle() {
    return normalizeVisualStyle(
      visualStyleRadios.find((radio) => radio.checked)?.value,
    );
  }
  ...
  function renderVisualStyle(value) {
    ...
    if (
      ...
      selectPopupTab("courseTab");
    if (normalized !== "gaming") {
      for (const sprite of [
        turboTestsSprite,
        objectivesSprite,
        testCollectionSprite,
        materialsSprite,
        autoplayControlSprite,
        floatingMenuControlSprite,
        commissionControlSprite,
    ...
    for (const radio of visualStyleRadios)
      radio.checked = radio.value === normalized;
  }
  ...
  function selectedMenuSize() {
    return normalizeMenuSize(
      menuSizeRadios.find((radio) => radio.checked)?.value,
    );
  }
  ...
  function operationLabel(operation) {
    ...
    if (operation.kind === "turbo")
      return "I test automatici sono in esecuzione.";
    if (operation.kind === "objectives")
      return "Il completamento degli Obiettivi è in esecuzione.";
    if (operation.kind === "tests")
      return "È in corso la raccolta dei test del corso.";
    if (operation.kind === "materials")
      return "È in corso la raccolta delle dispense del corso.";
  ...
  function renderOperation(operation) {
    ...
    turboTestsButtonLabel.textContent = turbo
      ? stopping
        ? "Interruzione dei test…"
        : "Interrompi i test automatici"
      : "Completa tutti i test";
    turboTestsButton.disabled = (busy && !turbo) || stopping;
    turboTestsStatus.textContent = turbo
      ? operation.message || "Test automatici in esecuzione…"
      : "";
  ...
  function renderCommissionUpdates(stored = {}) {
    ...
    const exams = Array.isArray(stored.commissionExams)
    ...
    commissionLastCheck.textContent = formatCommissionCapture(
      stored.commissionExamsCapturedAt,
    );
  ...
  chrome.storage.local.get(
    ...
    (result) => {
      ...
      chapterLimitMaps = {
        ...
        sessions: result.autoplayChapterLimitSessions || {},
      };
      chapterLimitStatuses = result.autoplayChapterLimitStatuses || {};
      autoplayStopAt70BypassedCourses =
        result.autoplayStopAt70BypassedCourses || {};
      renderCourseProgressPreferences(
        result.courseProgressOverlayEnabled,
        result.courseProgressOverlayPosition,
        result.courseProgressThresholdEnabled,
        result.autoplayStopAt70Enabled,
      );
      ...
      gamingCosmetics = achievements.normalizeCosmetics(
        result.gamingCosmetics,
        result.studywingAchievements,
      );
      updateAutoplayControls();
      updateStatus(result.enabled);
      renderOperation(result.pegasoActiveOperation);
      renderCommissionUpdates(result);
      renderCourseProgress();
      renderAchievements(result.studywingAchievements);
  ...
  chrome.storage.onChanged.addListener((changes, area) => {
    ...
    if (changes.playbackErrorRecovery)
      renderPlaybackErrorRecovery(changes.playbackErrorRecovery.newValue);
    if (
    ...
    if (changes.studywingAchievements)
      renderAchievements(changes.studywingAchievements.newValue);
    if (changes.gamingCosmetics) {
      gamingCosmetics = achievements.normalizeCosmetics(
        changes.gamingCosmetics.newValue,
        achievementState,
      );
      renderRewards();
    }
    if (changes.themePreference)
      renderThemePreference(changes.themePreference.newValue);
    if (changes.menuSize) renderMenuSize(changes.menuSize.newValue);
    if (changes.floatingMenuEnabled)
      floatingMenuEnabledCheckbox.checked =
        changes.floatingMenuEnabled.newValue === true;
    ...
    if (changes.commissionCheckEnabled)
      commissionCheckEnabledCheckbox.checked =
        changes.commissionCheckEnabled.newValue === true;
    if (
  ...
  findFirstIncompleteButton.addEventListener("click", () => {
    ...
    firstIncompleteStatus.textContent =
      "Avvio della ricerca dall’inizio del corso…";
    withActiveCourseTab((tabId) => {
      if (!tabId) {
        firstIncompleteStatus.textContent =
          "Apri prima la pagina delle lezioni di un corso.";
        updateAutoplayControls();
        return;
      }
      chrome.tabs.sendMessage(
        ...
        (response) => {
          if (chrome.runtime.lastError || !response?.accepted) {
            firstIncompleteStatus.textContent =
              response?.reason ||
              "Impossibile avviare la ricerca. Ricarica la pagina del corso e riprova.";
            updateAutoplayControls();
            return;
          }
  ...
  chapterLimitEnabledCheckbox.addEventListener("change", () => {
    chrome.storage.local.set({
      autoplayChapterLimitEnabled: chapterLimitEnabledCheckbox.checked,
    });
    if (chapterLimitEnabledCheckbox.checked && chapterLimitStatus?.courseCode)
      claimAchievement("configure-autoplay-limit");
  });
  chapterLimitMinus.addEventListener("click", () =>
    updateChapterLimitValue((Number(chapterLimitStatus?.limit) || 1) - 1),
  );
  chapterLimitPlus.addEventListener("click", () =>
    updateChapterLimitValue((Number(chapterLimitStatus?.limit) || 1) + 1),
  );
  ...
  chapterLimitSlider.addEventListener("input", () => {
    ...
    chapterLimitSlider.dataset.flameLevel = String(
      flameLevelForLimit(
        Number(chapterLimitSlider.value),
        Number(chapterLimitSlider.max),
      ),
    );
  });
  chapterLimitSlider.addEventListener("change", () =>
    updateChapterLimitValue(chapterLimitSlider.value),
  );
  ...
  courseProgressOverlayEnabledCheckbox.addEventListener("change", () => {
    chrome.storage.local.set({
      courseProgressOverlayEnabled:
        courseProgressOverlayEnabledCheckbox.checked,
    });
    if (courseProgressOverlayEnabledCheckbox.checked)
      claimAchievement("enable-progress-overlay");
  });
  for (const radio of courseProgressPositionRadios)
    radio.addEventListener("change", () => {
      if (!radio.checked) return;
      chrome.storage.local.set({
        courseProgressOverlayPosition: normalizedCourseProgressPosition(
          radio.value,
        ),
      });
    });
  courseProgressThresholdEnabledCheckbox.addEventListener("change", () => {
    chrome.storage.local.set({
      courseProgressThresholdEnabled:
        courseProgressThresholdEnabledCheckbox.checked,
    });
    if (courseProgressThresholdEnabledCheckbox.checked)
      claimAchievement("enable-70-advice");
  });
  ...
  autoplayStopAt70Resume.addEventListener("click", () =>
    updateAutoplayStopAt70Bypass(true),
  );
  for (const radio of playbackErrorRecoveryRadios)
    radio.addEventListener("change", () => {
      if (!radio.checked) return;
      chrome.storage.local.set({
        playbackErrorRecovery: selectedPlaybackErrorRecovery(),
      });
      playActionAnimation(playbackRecoveryControlSprite);
    });
  soundNotificationsEnabledCheckbox.addEventListener("change", () => {
    chrome.storage.local.set({
      soundNotificationsEnabled: soundNotificationsEnabledCheckbox.checked,
    });
    ...
    if (soundNotificationsEnabledCheckbox.checked)
      playActionAnimation(soundNotificationControlSprite);
  });
  notificationSoundSelect.addEventListener("change", () =>
    chrome.storage.local.set({
      notificationSound: soundApi.normalizeSound(notificationSoundSelect.value),
    }),
  );
  ...
  notificationVolumeInput.addEventListener("change", () =>
    chrome.storage.local.set({
      notificationVolume: soundApi.normalizeVolume(
        notificationVolumeInput.value,
      ),
    }),
  );
  previewNotificationSoundButton.addEventListener(
    "click",
    previewNotificationSound,
  );
  for (const radio of visualStyleRadios)
  ...
  floatingMenuEnabledCheckbox.addEventListener("change", () => {
    chrome.storage.local.set({
      floatingMenuEnabled: floatingMenuEnabledCheckbox.checked,
    });
    if (floatingMenuEnabledCheckbox.checked)
      playActionAnimation(floatingMenuControlSprite);
    if (floatingMenuEnabledCheckbox.checked)
      claimAchievement("open-floating-menu");
  });
  ...
  commissionCheckEnabledCheckbox.addEventListener("change", () => {
    ...
    if (commissionCheckEnabledCheckbox.checked)
      playActionAnimation(commissionControlSprite);
    if (commissionCheckEnabledCheckbox.checked)
      claimAchievement("enable-commission-check");
  });

  resetAchievementsButton.addEventListener("click", () => {
    if (
      !window.confirm(
        "Vuoi cancellare definitivamente Traguardi, EXP e ricompense cosmetiche? Le altre preferenze di PlumePilot non verranno modificate.",
      )
    )
      return;
      ...
      () => {
        if (chrome.runtime.lastError)
          achievementFeedback.textContent =
            "Non è stato possibile reimpostare i Traguardi. Riprova.";
        else {
          renderAchievements(null);
          achievementFeedback.textContent = "Traguardi ed EXP reimpostati.";
        }
      },
    );
  });

  for (const list of [barRewards, launcherRewards])
    list.addEventListener("click", (event) => {
      const button = event.target.closest(
        "[data-reward-kind][data-reward-style]",
      );
      if (button)
        applyReward(button.dataset.rewardKind, button.dataset.rewardStyle);
    });
  ...
  confirmedExamsToggle.addEventListener("click", () => {
    const expanded =
      confirmedExamsToggle.getAttribute("aria-expanded") !== "true";
    ...
    runtimeMessage({ type: "PEGASO_CLEAR_COMMISSION_MEMORY_ALL_TABS" }).then(
      () => {
        chrome.storage.local.remove(COMMISSION_STORAGE_KEYS, () => {
          if (chrome.runtime.lastError) {
            clearCommissionDataStatus.textContent =
              "Non è stato possibile cancellare i dati. Riprova.";
          } else {
            clearCommissionDataStatus.textContent =
  ...
  function openInfoPanel(panel) {
    ...
    const animation = panel.animate(
      ...
      {
        duration: reduceMotion.matches ? 0 : 220,
        easing: "ease",
        fill: "forwards",
      },
    );
  ...
  const infoToggleButtons = document.querySelectorAll(
    ".expand-button, .about-link",
  );
  ...
  turboTestsButton.addEventListener("click", () => {
    ...
    turboTestsStatus.textContent = stopping
  ...
  async function toggleMaterialsExport() {
    const collecting =
      activeOperation?.kind === "materials" &&
      activeOperation?.phase === "collecting";
    if (!collecting) {
