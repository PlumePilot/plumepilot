...
assert.match(sourceReadme, /^# PlumePilot 2\.33\.2/m);
assert.match(sourceReadme, /plumepilot-v2\.33\.2-firefox\.zip/);
assert.match(releaseNotes, /no feature or permission changes/i);

console.log("PASS: 2.33.2 version, release documentation and PDF/EPUB branding are aligned");
