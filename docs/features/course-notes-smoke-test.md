...
5. Scaricare PDF e HTML. Nel PDF controllare copertina, indice cliccabile per capitolo, segnalibri modulo/capitolo, gerarchia capitolo/video e la stessa palette rosa–viola della raccolta test. Verificare note multiple, accenti/simboli e un appunto lungo su più pagine. Il PDF segnala i caratteri non supportati e suggerisce HTML; non li sostituisce silenziosamente.
6. Aprire l'HTML senza connessione. Verificare la navigazione laterale per capitolo e che ogni pagina raggruppi i relativi video e appunti. Aprire **Integrazione all’appunto**, aggiungere `<test>`, `&`, accenti, una nuova riga e simboli dalla palette matematica. Cambiare tema, scaricare la copia aggiornata e riaprirla: integrazioni, indicatore **Appunti presenti** e tema devono essere conservati. Pegaso deve rimanere invariato.
...
9. Verificare i pulsanti a Piccolo/Medio/Grande, Standard/Gaming e Chiaro/Scuro. Il pulsante appunti deve occupare l’intera larghezza e avere dimensioni, colore, hover e sprite coerenti con raccolta test/dispense in entrambe le interfacce. Nel popup, le frecce devono mostrare e nascondere una sola descrizione alla volta, senza salti o ridimensionamenti intermedi. Chiudere il builder durante la generazione: nessun blocco persistente delle operazioni.
