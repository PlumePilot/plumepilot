...
9. Verificare i pulsanti a Piccolo/Medio/Grande, Standard/Gaming e Chiaro/Scuro. Il pulsante appunti deve avere dimensioni, colore, hover e sprite coerenti con raccolta test/dispense in entrambe le interfacce. Nel popup, la freccia deve mostrare e nascondere la descrizione. Chiudere il builder durante la generazione: nessun blocco persistente delle operazioni.
